...
export const Image = ({ className, onClick, src, alt, style, id }) => {
    return (
        <img src={src} alt={alt} className={className} id={id} style={style} onClick={onClick} />
    )
}
...
export const A = ({ className, children, onClick, href, style, id, target }) => {
    return (
        <a target={target} href={href} className={className} onClick={onClick} id={id} style={style}>
            {children}
        </a>
    )
}
...
export const Button = ({ className, children, onClick, type, style, id }) => {
    return (
        <button className={className} onClick={onClick} id={id} style={style} type={type}>
            {children}
        </button>
    )
}
...
export const Form = ({ className, children, onClick, style, onSubmit, id }) => {
    return (
        <form className={className} onClick={onClick} id={id} style={style} onSubmit={onSubmit}>
            {children}
        </form>
    )
}